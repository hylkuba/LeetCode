...
/**
 * @brief There are n rooms labeled from 0 to n - 1 and all the rooms are locked except for room 0. Your goal is to visit all the rooms. However, you cannot enter a locked room without having its key.
...
int main(void) {
    ...
    std::cout << sol.canVisitAllRooms(rooms) << std::endl;
    return 0;
}